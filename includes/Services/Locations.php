...
class Locations extends gEditorial\Service
{
	...
	public static function prepLatLng( mixed $input, ?string $context = NULL, null|false|string $fallback = '' ): null|false|string
	{
		...
		// `return Core\LatLng::prep( $data );`
		return Lookup::htmlLatLng( $data );
	}
