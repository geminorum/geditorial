...
* **htmldescription** - pipe delicious hot HTML to the description of your calendar invite
...
$ics = new ICS(array(
  ...
  'description' => trim(preg_replace( "/\r|\n/", "", preg_replace('/\s\s+/', ' ', $_POST['description']))),
  'htmldescription' => trim(preg_replace( "/\r|\n/", "", $_POST['description'])),
