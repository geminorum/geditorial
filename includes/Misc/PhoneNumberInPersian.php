...
// @source https://github.com/persian-tools/php-persian-tools/blob/master/src/Traits/PhoneNumber.php

class PhoneNumberInPersian extends Core\Base
{
	public static $MCI = [
		'910' => [
			'base'     => 'کشوری',
	...
	{
		return preg_match( static::$mobileRegex, $mobile )
			&& in_array( self::getPhonePrefix( $mobile ), self::prefixes() );
	}
