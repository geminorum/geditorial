...
/**
 * Adopted from `ariColor`
 * @author `Aristeides Stathopoulos`
 * @version 1.1.0 - 2026-02-08
 * @source https://github.com/aristath/ariColor
 * @package `aristath/ari-color`
 */

class ColorCalc extends Core\Base
{
	/**
	...
	/**
	 * Alpha value (minimum: 0, maximum: 1)
	 *
	 * @access public
	 * @since 1.0.0
	 * @var float
	...
	/**
	 * An array containing brightness-es.
	 *
	 * @access public
	 * @since 1.0.0
	 * @var array
