<?php namespace geminorum\gEditorial\Modules\Metropolis;
...
class Metropolis extends gEditorial\Module
{
	...
	public static function module()
	{
		return [
			'name'     => 'metropolis',
			'title'    => _x( 'Metropolis', 'Modules: Metropolis', 'geditorial-admin' ),
			'desc'     => _x( 'Content Capitals', 'Modules: Metropolis', 'geditorial-admin' ),
			'icon'     => [ 'misc-16', 'octicons-location' ],
			'access'   => 'beta',
			'keywords' => [
				'geo',
				'regional',
	...
	protected function get_global_settings()
	{
		...
		return [
			...
			'_constants' => [
				'main_taxonomy_constant'  => [ NULL, 'city' ],
				'main_shortcode_constant' => [ NULL, 'cities' ],
			],
		];
	}
	...
	protected function get_global_strings()
	{
		$strings = [
			'noops' => [
				'main_taxonomy' => _n_noop( 'City', 'Cities', 'geditorial-metropolis' ),
			],
			'labels' => [
				'main_taxonomy' => [
					'extended_label'       => _x( 'Cities Directory', 'Label: `extended_label`', 'geditorial-metropolis' ),
					'menu_name'            => _x( 'Cities Directory', 'Label: `menu_name`', 'geditorial-metropolis' ),
					'show_option_all'      => _x( 'Cities', 'Label: `show_option_all`', 'geditorial-metropolis' ),
					'show_option_no_items' => _x( '(Undefined)', 'Label: `show_option_no_items`', 'geditorial-metropolis' ),
				],
			],
		];
	...
	protected function define_default_terms()
	{
		return [
			'main_taxonomy' => [
				'tehran' => _x( 'Tehran', 'Main Taxonomy: Default Term', 'geditorial-metropolis' ),
			],
		];
	}
	...
	public function init()
	{
		...
		$this->register_taxonomy( 'main_taxonomy', [
			...
			'data_length'        => _x( '20', 'Main Taxonomy Argument: `data_length`', 'geditorial-metropolis' ),
		], NULL, [
