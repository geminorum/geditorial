...
class Subjects extends gEditorial\Module
{
	...
	protected function get_global_settings()
	{
		...
		return [
			...
			'_constants' => [
				'main_taxonomy_constant'  => [ NULL, 'subject' ],
				'main_shortcode_constant' => [ NULL, 'subjects' ],
			],
		];
	}
	...
	{
		return [
			'main_taxonomy'  => 'subject',
			'main_shortcode' => 'subjects',
		];
	}
	...
	protected function get_global_strings()
	{
		$strings = [
			'noops' => [
				'main_taxonomy' => _n_noop( 'Subject', 'Subjects', 'geditorial-subjects' ),
			],
			'labels' => [
				'main_taxonomy' => [
					'extended_label'       => _x( 'Content Subjects', 'Label: `extended_label`', 'geditorial-subjects' ),
					'menu_name'            => _x( 'Content Subjects', 'Label: `menu_name`', 'geditorial-subjects' ),
					'show_option_all'      => _x( 'Subjects', 'Label: `show_option_all`', 'geditorial-subjects' ),
					'show_option_no_items' => _x( '(Unsubjected)', 'Label: `show_option_no_items`', 'geditorial-subjects' ),
				],
			],
		];
	...
	public function init()
	{
		...
		$this->register_taxonomy( 'main_taxonomy', [
			...
			'data_length'        => _x( '20', 'Main Taxonomy Argument: `data_length`', 'geditorial-subjects' ),
		], NULL, [
	...
	public function current_screen( $screen )
	{
		if ( $this->is_screen_taxonomy( 'main_taxonomy', $screen ) ) {
			...
			if ( 'edit' === $screen->base ) {
				...
				$this->coretax__hook_posttype_mainbox( 'main_taxonomy', $screen, TRUE, FALSE, FALSE );
			}
		}
	}
