...
class Conditioned extends gEditorial\Module
{
	...
	protected function get_global_strings()
	{
		$strings = [
			'noops' => [
				'main_taxonomy' => _n_noop( 'Condition', 'Conditions', 'geditorial-conditioned' ),
			],
			'labels' => [
				'main_taxonomy' => [
					'menu_name'            => _x( 'Condition Ranks', 'Label: Menu Name', 'geditorial-conditioned' ),
					'show_option_all'      => _x( 'Condition Ranks', 'Label: Show Option All', 'geditorial-conditioned' ),
					'show_option_no_items' => _x( '(Unranked)', 'Label: Show Option No Terms', 'geditorial-conditioned' ),
				],
			],
		];
		...
		$strings['dashboard'] = [
			'current' => [ 'widget_title' => _x( 'Your Team Definition Summary', 'Dashboard Widget Title', 'geditorial-conditioned' ), ],
			'all'     => [ 'widget_title' => _x( 'Editorial Definition Summary', 'Dashboard Widget Title', 'geditorial-conditioned' ), ],
		];
	...
	{
		return [
			'main_taxonomy' => ModuleInfo::getConditionRanks( 'strings' ),
		];
	}
