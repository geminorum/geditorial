<?php namespace geminorum\gEditorial\Modules\Glossary;
...
class Glossary extends gEditorial\Module
{
	...
	public static function module()
	{
		return [
			'name'     => 'glossary',
			'title'    => _x( 'Glossary', 'Modules: Glossary', 'geditorial-admin' ),
			'desc'     => _x( 'Content List of Words', 'Modules: Glossary', 'geditorial-admin' ),
			'icon'     => [ 'misc-16', 'journal-bookmark-fill' ],
			'access'   => 'beta',
			'keywords' => [
				'has-shortcodes',
				'taxmodule',
