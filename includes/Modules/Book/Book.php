...
class Book extends gEditorial\Module
{
	...
	public function serie_shortcode( null|string|array $atts = [], ?string $content = NULL, string $tag = '' ): mixed
	{
	...
	public function p2p_shortcode( null|string|array $atts = [], ?string $content = NULL, string $tag = '' ): mixed
	{
		if ( ! $this->_p2p )
			return $content;
