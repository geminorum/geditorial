<?php namespace geminorum\gEditorial\Modules\Mobilized;
...
class Mobilized extends gEditorial\Module
{
	...
	public static function module()
	{
		return [
			'name'     => 'mobilized',
			'title'    => _x( 'Mobilized', 'Modules: Mobilized', 'geditorial-admin' ),
			'desc'     => _x( 'Volunteered National Service', 'Modules: Mobilized', 'geditorial-admin' ),
			'icon'     => 'superhero',
			'access'   => 'beta',
			'keywords' => [
				'taxmodule',
	...
	protected function get_global_strings()
	{
		$strings = [
			'noops' => [
				'main_taxonomy' => _n_noop( 'Mobilization', 'Mobilizations', 'geditorial-mobilized' ),
			],
			'labels' => [
				'main_taxonomy' => [
					'menu_name'            => _x( 'Content Mobilizations', 'Label: Menu Name', 'geditorial-mobilized' ),
					'show_option_all'      => _x( 'Mobilizations', 'Label: Show Option All', 'geditorial-mobilized' ),
					'show_option_no_items' => _x( '(Undefined)', 'Label: Show Option No Terms', 'geditorial-mobilized' ),
				],
			],
		];
	...
	public function current_screen( $screen )
	{
		if ( $this->is_screen_taxonomy( 'main_taxonomy', $screen ) ) {
			...
			if ( 'edit' === $screen->base ) {
				...
				$this->coretax__hook_posttype_mainbox( 'main_taxonomy', $screen );
			}
		}
	}
