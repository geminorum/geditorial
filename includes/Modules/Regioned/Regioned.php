...
class Regioned extends gEditorial\Module
{
	...
	protected function get_global_strings()
	{
		...
		$strings['dashboard'] = [
			'current' => [ 'widget_title' => _x( 'Your Team Regionality Summary', 'Dashboard Widget Title', 'geditorial-regioned' ), ],
			'all'     => [ 'widget_title' => _x( 'Editorial Regionality Summary', 'Dashboard Widget Title', 'geditorial-regioned' ), ],
		];
