...
class Collect extends gEditorial\Module
{
	...
	public function current_screen( object $screen ): void
	{
		...
		if ( $this->is_screen_posttype( 'collection_posttype', $screen ) ) {
	...
	public function group_shortcode( null|string|array $atts = [], ?string $content = NULL, string $tag = '' ): mixed
	{
	...
	public function poster_shortcode( null|string|array $atts = [], ?string $content = NULL, string $tag = '' ): mixed
	{
