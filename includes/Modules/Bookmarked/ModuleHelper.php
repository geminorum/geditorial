	...
	public static function getTypeOptions( ?string $context = NULL, ?string $path = NULL ): array
	{
		...
		return $data[$context] = [
			...
			[
				...
				'template' => add_query_arg( [ 'p' => '{{code}}' ], $home ),
			...
			[
				...
				'template' => add_query_arg( [ 'p' => '{{code}}', 'download' => '' ], $home ),
			...
			[
				...
				'template' => add_query_arg( [ 't' => '{{code}}' ], $home ),
			...
			[
				...
				'domains'    => [ 'nlai.ir', 'opac.nlai.ir' ],
				'extraction' => '/(^https?:?\/\/)(www\.)?opac\.nlai\.ir\/opac\-prod\/bibliographic\/(?P<code>[\d]+)(.+)?$/i',
			...
			[
				...
				'domains'    => [ 'goodreads.com', 'www.goodreads.com' ],
				'extraction' => '/(^https?:?\/\/)(www\.)?goodreads\.com\/book\/show\/(?P<code>[\d]+)(.+)?$/i',
				'cssclass'   => '-goodreads-book',
				'icon'       => [ 'misc-16', 'goodreads' ],
			...
			[
				...
				'domains'    => [ 'fidibo.com', 'www.fidibo.com' ],
				'extraction' => '/(^https?:?\/\/)(www\.)?fidibo\.com\/book\/(?P<code>[\d]+)(.+)?$/i',
			...
			[
				...
				'domains'    => [ 'taaghche.com', 'www.taaghche.com' ],
				'extraction' => '/(^https?:?\/\/)(www\.)?taaghche\.com\/book\/(?P<code>[\d]+)(.+)?$/i',
				'cssclass'   => '-taaghche-book',
				'icon'       => [ 'misc-16', 'taaghche' ],
			...
			[
				...
				'domains'    => [ 'behkhaan.ir', 'www.behkhaan.ir' ],
				'extraction' => '/(^https?:?\/\/)(www\.)?behkhaan\.ir\/books\/(?P<code>[^\?\n]+)(.+)?$/i',
				'discovery'  => '/(^https?:?\/\/)(www\.)?behkhaan\.ir\/books\/(?P<code>[^\?\n]+)(.+)?$/i',
				'cssclass'   => '-behkhaan-profile',
				'icon'       => [ 'misc-32', 'behkhaan' ],
				'logo'       => self::getLinkLogo( 'behkhaan', NULL, $context, $path ),
			...
			[
				...
				'domains'    => [ 'behkhaan.ir', 'www.behkhaan.ir' ],
				'extraction' => '/(^https?:?\/\/)(www\.)?behkhaan\.ir\/profile\/(?P<code>[^\?\n]+)(.+)?$/i',
				'discovery'  => '/(^https?:?\/\/)(www\.)?behkhaan\.ir\/profile\/(?P<code>[^\?\n]+)(.+)?$/i',
				'cssclass'   => '-behkhaan-profile',
				'icon'       => [ 'misc-32', 'behkhaan' ],
				'logo'       => self::getLinkLogo( 'behkhaan', NULL, $context, $path ),
			...
			[
				...
				'domains'  => [ 'aparat.com', 'www.aparat.com' ],
			...
			[
				...
				'domains'  => [ 'navaar.ir', 'www.navaar.ir' ],
