<?php namespace geminorum\gEditorial\Modules\Certificated;
...
class Certificated extends gEditorial\Module
{
	...
	protected function get_global_strings()
	{
		$strings = [
			'noops' => [
				'main_taxonomy' => _n_noop( 'Certification', 'Certifications', 'geditorial-certificated' ),
			],
			'labels' => [
				'main_taxonomy' => [
					'show_option_all'      => _x( 'Certifications', 'Label: Show Option All', 'geditorial-certificated' ),
					'show_option_no_items' => _x( '(Un-certificated)', 'Label: Show Option No Terms', 'geditorial-certificated' ),
				],
			],
		];
		...
		$strings['dashboard'] = [
			'current' => [ 'widget_title' => _x( 'Your Team Certification Summary', 'Dashboard Widget Title', 'geditorial-certificated' ), ],
			'all'     => [ 'widget_title' => _x( 'Editorial Certification Summary', 'Dashboard Widget Title', 'geditorial-certificated' ), ],
		];
