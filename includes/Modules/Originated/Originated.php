<?php namespace geminorum\gEditorial\Modules\Originated;
...
class Originated extends gEditorial\Module
{
	...
	public static function module()
	{
		return [
			'name'     => 'originated',
			'title'    => _x( 'Originated', 'Modules: Originated', 'geditorial-admin' ),
			'desc'     => _x( 'Origin of Contents', 'Modules: Originated', 'geditorial-admin' ),
	...
	protected function get_global_settings()
	{
		...
		return [
			...
			'_constants' => [
				'main_taxonomy_constant'  => [ NULL, 'origin' ],
				'main_shortcode_constant' => [ NULL, 'content-origins' ],
			],
		];
	}
	...
	{
		return [
			'main_taxonomy'  => 'origin',
			'main_shortcode' => 'content-origins',
		];
	}
	...
	protected function get_global_strings()
	{
		$strings = [
			'noops' => [
				'main_taxonomy' => _n_noop( 'Origin', 'Origins', 'geditorial-originated' ),
			],
			'labels' => [
				'main_taxonomy' => [
					'extended_label'       => _x( 'Content Origins', 'Label: `extended_label`', 'geditorial-originated' ),
					'menu_name'            => _x( 'Content Origins', 'Label: `menu_name`', 'geditorial-originated' ),
					'show_option_all'      => _x( 'Origins', 'Label: `show_option_all`', 'geditorial-originated' ),
					'show_option_no_items' => _x( '(Unoriginated)', 'Label: `show_option_no_items`', 'geditorial-originated' ),
				],
			],
		];
