...
class Importer extends gEditorial\Module
{
	...
	protected function get_global_constants(): array
	{
		return [
			...
			'metakey_source_id'     => 'import_source_id',          // public meta
		...
		if ( $this->get_setting( 'store_source_data' ) ) {
			...
			add_metadata( 'post',
				...
				[
					...
					'attach_id' => $atts['attach_id'],        // TODO: prepend filename
					'user_id'   => get_current_user_id(),     // TODO: prepend username
				],
				TRUE
			);
		}
	...
	private function _get_metakeys(): array
	{
		return Core\Arraay::prepString( $this->constants( [
			...
			'imported_source_log', // without leading underscore
		] );
	}
