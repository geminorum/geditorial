<?php namespace geminorum\gEditorial\Modules\Publishers;
...
class Publishers extends gEditorial\Module
{
	...
	public static function module()
	{
		return [
			'name'     => 'publishers',
			'title'    => _x( 'Publishers', 'Modules: Publishers', 'geditorial-admin' ),
			'desc'     => _x( 'Publishing Houses', 'Modules: Publishers', 'geditorial-admin' ),
			'icon'     => [ 'misc-16', 'book-half' ],
			'access'   => 'beta',
			'keywords' => [
				'branding',
				'has-shortcodes',
	...
	protected function get_global_settings()
	{
		...
		return [
			...
			'_constants' => [
				'main_taxonomy_constant'  => [ NULL, 'publisher' ],
				'main_shortcode_constant' => [ NULL, 'publishers' ],
			],
		];
	}
	...
	{
		return [
			'main_taxonomy'  => 'publisher',
			'main_shortcode' => 'publishers',
		];
	}
	...
	protected function get_global_strings()
	{
		$strings = [
			'noops' => [
				'main_taxonomy' => _n_noop( 'Publisher', 'Publishers', 'geditorial-publishers' ),
			],
			'labels' => [
				'main_taxonomy' => [
					'extended_label'       => _x( 'Publishers Directory', 'Label: `extended_label`', 'geditorial-publishers' ),
					'menu_name'            => _x( 'Publishers Directory', 'Label: `menu_name`', 'geditorial-publishers' ),
					'show_option_all'      => _x( 'Publishers', 'Label: `show_option_all`', 'geditorial-publishers' ),
					'show_option_no_items' => _x( '(Undefined)', 'Label: `show_option_no_items`', 'geditorial-publishers' ),
				],
			],
		];
	...
	public function init()
	{
		...
		$this->register_taxonomy( 'main_taxonomy', [
			...
			'data_length'        => _x( '20', 'Main Taxonomy Argument: `data_length`', 'geditorial-publishers' ),
		], NULL, [
