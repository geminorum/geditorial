		...
		return [
			'_general' => [
				...
				[
					...
					'description' => _x( 'Supports term tagline for selected taxonomies.', 'Modules: Terms: Setting Description', GEDITORIAL_TEXTDOMAIN ),
	...
	protected function get_global_strings()
	{
		return [
			...
			'descriptions' => [
				...
				'tagline'   => _x( 'Gives more information about the term in a short, bite-size phrase.', 'Modules: Terms: Descriptions', GEDITORIAL_TEXTDOMAIN ),
