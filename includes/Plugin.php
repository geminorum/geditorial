...
class Plugin
{
	...
	private function require_core()
	{
		$this->files( [
			...
			'P2P/Utils',
			'P2P/Exception',
			'P2P/ConnectionTypeFactory',
			'P2P/ConnectionType',
			'P2P/DirectionStrategy',
			'P2P/DirectedConnectionType',
			'P2P/DeterminateConnectionType',
			'P2P/IndeterminateConnectionType',
			'P2P/IndeterminateDirectedConnectionType',
			'P2P/ReciprocalConnectionType',
			'P2P/Side',
			'P2P/SidePost',
			'P2P/SideAttachment',
			'P2P/SideUser',
