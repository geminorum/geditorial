		...
		if ( count( $posts ) ) {
			foreach ( $posts as $post ) {
				...
				if ( $args['cb'] ) {
					...
					$order = $args['order_before'] ? gEditorialNumber::format( $args['order_zeroise'] ? gEditorialNumber::zeroise( $post->menu_order, $args['order_zeroise'] ) : $post->menu_order ).$args['order_sep'] : '';
