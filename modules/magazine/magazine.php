...
class gEditorialMagazine extends gEditorialModuleCore
{
	...
	protected function get_global_strings()
	{
		return array(
			...
			'labels' => array(
				'issue_cpt' => array(
					'name'                  => _x( 'Issues', 'Magazine Module: Issue CPT: Name', GEDITORIAL_TEXTDOMAIN ),
					'menu_name'             => _x( 'Issues', 'Magazine Module: Issue CPT: Menu Name', GEDITORIAL_TEXTDOMAIN ),
					'singular_name'         => _x( 'Issue', 'Magazine Module: Issue CPT: Singular Name', GEDITORIAL_TEXTDOMAIN ),
					'description'           => _x( 'Issue Post Type', 'Magazine Module: Issue CPT: Description', GEDITORIAL_TEXTDOMAIN ),
					'add_new'               => _x( 'Add New', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'add_new_item'          => _x( 'Add New Issue', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'edit_item'             => _x( 'Edit Issue', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'new_item'              => _x( 'New Issue', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'view_item'             => _x( 'View Issue', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'search_items'          => _x( 'Search Issues', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'not_found'             => _x( 'No issues found.', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'not_found_in_trash'    => _x( 'No issues found in Trash.', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'parent_item_colon'     => _x( 'Parent Issue:', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'all_items'             => _x( 'All Issues', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'archives'              => _x( 'Issue Archives', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'insert_into_item'      => _x( 'Insert into issue', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'uploaded_to_this_item' => _x( 'Uploaded to this issue', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'featured_image'        => _x( 'Cover Image', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'set_featured_image'    => _x( 'Set cover image', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'remove_featured_image' => _x( 'Remove cover image', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'use_featured_image'    => _x( 'Use as cover image', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'filter_items_list'     => _x( 'Filter issues list', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'items_list_navigation' => _x( 'Issues list navigation', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
					'items_list'            => _x( 'Issues list', 'Magazine Module: Issue CPT', GEDITORIAL_TEXTDOMAIN ),
				),
				'issue_tax' => array(
                    'name'                  => _x( 'Issues', 'Magazine Module: Issue Tax: Name', GEDITORIAL_TEXTDOMAIN ),
                    'menu_name'             => _x( 'Issues', 'Magazine Module: Issue Tax: Menu Name', GEDITORIAL_TEXTDOMAIN ),
                    'singular_name'         => _x( 'Issue', 'Magazine Module: Issue Tax: Singular Name', GEDITORIAL_TEXTDOMAIN ),
                    'search_items'          => _x( 'Search Issues', 'Magazine Module: Issue Tax', GEDITORIAL_TEXTDOMAIN ),
                    'all_items'             => _x( 'All Issues', 'Magazine Module: Issue Tax', GEDITORIAL_TEXTDOMAIN ),
                    'parent_item'           => _x( 'Parent Issue', 'Magazine Module: Issue Tax', GEDITORIAL_TEXTDOMAIN ),
                    'parent_item_colon'     => _x( 'Parent Issue:', 'Magazine Module: Issue Tax', GEDITORIAL_TEXTDOMAIN ),
                    'edit_item'             => _x( 'Edit Issue', 'Magazine Module: Issue Tax', GEDITORIAL_TEXTDOMAIN ),
                    'view_item'             => _x( 'View Issue', 'Magazine Module: Issue Tax', GEDITORIAL_TEXTDOMAIN ),
                    'update_item'           => _x( 'Update Issue', 'Magazine Module: Issue Tax', GEDITORIAL_TEXTDOMAIN ),
                    'add_new_item'          => _x( 'Add New Issue', 'Magazine Module: Issue Tax', GEDITORIAL_TEXTDOMAIN ),
                    'new_item_name'         => _x( 'New Issue Name', 'Magazine Module: Issue Tax', GEDITORIAL_TEXTDOMAIN ),
                    'not_found'             => _x( 'No issues found.', 'Magazine Module: Issue Tax', GEDITORIAL_TEXTDOMAIN ),
                    'no_terms'              => _x( 'No issues', 'Magazine Module: Issue Tax', GEDITORIAL_TEXTDOMAIN ),
                    'items_list_navigation' => _x( 'Issues list navigation', 'Magazine Module: Issue Tax', GEDITORIAL_TEXTDOMAIN ),
                    'items_list'            => _x( 'Issues list', 'Magazine Module: Issue Tax', GEDITORIAL_TEXTDOMAIN ),
				),
				'span_tax' => array(
                    'name'                       => _x( 'Spans', 'Magazine Module: Span Tax: Name', GEDITORIAL_TEXTDOMAIN ),
                    'menu_name'                  => _x( 'Spans', 'Magazine Module: Span Tax: Menu Name', GEDITORIAL_TEXTDOMAIN ),
                    'singular_name'              => _x( 'Span', 'Magazine Module: Span Tax: Singular Name', GEDITORIAL_TEXTDOMAIN ),
                    'search_items'               => _x( 'Search Spans', 'Magazine Module: Span Tax', GEDITORIAL_TEXTDOMAIN ),
                    'popular_items'              => NULL, // _x( 'Popular Spans', 'Magazine Module: Span Tax', GEDITORIAL_TEXTDOMAIN ),
                    'all_items'                  => _x( 'All Spans', 'Magazine Module: Span Tax', GEDITORIAL_TEXTDOMAIN ),
                    'edit_item'                  => _x( 'Edit Span', 'Magazine Module: Span Tax', GEDITORIAL_TEXTDOMAIN ),
                    'view_item'                  => _x( 'View Span', 'Magazine Module: Span Tax', GEDITORIAL_TEXTDOMAIN ),
                    'update_item'                => _x( 'Update Span', 'Magazine Module: Span Tax', GEDITORIAL_TEXTDOMAIN ),
                    'add_new_item'               => _x( 'Add New Span', 'Magazine Module: Span Tax', GEDITORIAL_TEXTDOMAIN ),
                    'new_item_name'              => _x( 'New Span Name', 'Magazine Module: Span Tax', GEDITORIAL_TEXTDOMAIN ),
                    'separate_items_with_commas' => _x( 'Separate spans with commas', 'Magazine Module: Span Tax', GEDITORIAL_TEXTDOMAIN ),
                    'add_or_remove_items'        => _x( 'Add or remove spans', 'Magazine Module: Span Tax', GEDITORIAL_TEXTDOMAIN ),
                    'choose_from_most_used'      => _x( 'Choose from the most used spans', 'Magazine Module: Span Tax', GEDITORIAL_TEXTDOMAIN ),
                    'not_found'                  => _x( 'No spans found.', 'Magazine Module: Span Tax', GEDITORIAL_TEXTDOMAIN ),
